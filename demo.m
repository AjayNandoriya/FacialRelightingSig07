...
subplot(221);imshow(img,[]);title('Source L1')
subplot(222);imshow(imgA,[]);title('Reference L1')
subplot(223);imshow(imgB,[]);title('Reference L2')
subplot(224);imshow(results.out_img,[]);title('Output')